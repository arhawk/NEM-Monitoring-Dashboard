...
ASSIGNMENT1_STAGING_DIR = staging_data_path("assignment1")
NGER_PATH = ASSIGNMENT1_STAGING_DIR / "NGER_data_clean.csv"
CER_PATH = ASSIGNMENT1_STAGING_DIR / "CER_data_clean.csv"
